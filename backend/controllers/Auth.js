...
exports.resendOtp=async(req,res)=>{
    try {
        ...
        await sendMail(existingUser.email,`OTP Verification for Your VOID Account`,`Your One-Time Password (OTP) for account verification is: <b>${otp}</b>.</br>Do not share this OTP with anyone for security reasons`)
...
exports.forgotPassword=async(req,res)=>{
    ...
    try {
        ...
        await sendMail(isExistingUser.email,'Password Reset Link for Your Void Account',`<p>Dear ${isExistingUser.name},

        We received a request to reset the password for your Void account. If you initiated this request, please use the following link to reset your password:</p>
